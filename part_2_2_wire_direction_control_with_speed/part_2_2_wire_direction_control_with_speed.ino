 ...
 *  
 *  Part 2 - 2 Wire Direction Control And Speed Control using 1 PWM PIN. 
...
#define in1 3 // PWM for this demo.
#define in2 4
...
void setup() {
 ...
 analogWrite(in1, 0); //analogWrite is how we make PWM on the Arduino zero is equivlant to LOW
...
for (speed = maxSpeed; speed > stallSpeed; speed--) {
  //Spin Motor in the other direction
  analogWrite(in1, 255 - speed); //Notice what we did here - this is called inverted logic and lets us use just one PWM pin and 2 wires to drive a motor
